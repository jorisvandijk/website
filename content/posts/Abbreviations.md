...
First install the program[^2]. Then add an abbreviation in terminal:
...
For more commands, see the documentation[^3].
...
[^2]: [zsh-abbr: Installation](https://zsh-abbr.olets.dev/installation.html)
[^3]: [zsh-abbr: Commands](https://zsh-abbr.olets.dev/commands.html)
