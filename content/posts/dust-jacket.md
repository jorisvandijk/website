...
It’s pretty simple, turns out. I just did an `ls` in my books directory and fed that to an AI. I then posed: “Please sort these books by genre and add a blurb to each, consisting of five lines maximum. Then provide it to me in an `epub` format”.

This gave me an e-book index of all my books on the reader with blurbs on what they were about. This makes discovery so much easier and on-device, instead of relying on me to google stuff. I refer to it after each book I read to pick the next. My wife saw me do this and made me make her one too. It’s now how she browses her books as well.
