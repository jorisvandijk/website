...
After so many times, I got sick of this and decided, well—I am already mirroring the repository to GitLab (as well as to Codeberg, because you can never have too many backups), I'll just move my hosting away from GitHub and to GitLab.
